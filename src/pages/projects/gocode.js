...
function GoCode() {
  return (
    <LayoutProjectBlog footnote={require('../../images/blog-footnotes/iphone.png')}>
      ...
      Google Play Store. I felt like I had created such a clean, streamlined app. Surely <i>somebody</i> wanted to use it.</BlogText>
      <br/>
      ...
      <BlogText>I decided to step away from GoCode the summer before my freshman year at Vanderbilt.</BlogText>
